...
(function () {
    ...
    const BOSE_TOUR_STEPS_FALLBACK = {
        ...
        checkout: [
            ...
            { page: ['checkout.html'], mode: 'info', selector: '#bose-deposit-payment-box', title: 'طريقة الدفع', text: 'حوّلي المبلغ كامل كاش أو InstaPay على رقم المتجر، واكتبي رقم المحفظة أو الهاتف اللي حوّلتي منه في الخانة اللي تحتها.' },
