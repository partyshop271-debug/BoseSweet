...
(function () {
    ...
    const BOSE_TOUR_STEPS_FALLBACK = {
        sidebar: [
            ...
            { page: ['index.html'], mode: 'info', selector: '#sidebar-link-rewards', title: 'مكافآتك', text: 'وده نظام المكافآت بتاعنا - خصم ولاء تلقائي على طلباتك من غير أي كود.', section: 'links' },
        ...
        homepage: [
            ...
            { page: ['index.html'], mode: 'info', selector: '#loyalty-teaser-section', title: 'نظام المكافآت', text: 'خصم تلقائي على طلباتك من غير أي كود - اكتبي رقم موبايلك هنا تتابعي رصيدك.', section: 'sections' },
        ],
        product: [
            ...
            { page: ['category.html'], mode: 'click', selector: '.product-card', hint: 'دوسي على أي منتج زي اللي قدامك دلوقتي', title: 'اختاري الصنف', text: 'دوسي على أي منتج زي ده عشان تشوفي تفاصيله وسعره بالكامل - هتفتحلك صفحة المنتج.' },
            // 🆕👑 [رجوع صفحة المنتج المستقلة]: تفاصيل المنتج بقت صفحة حقيقية
            // (product.html) بدل نافذة منبثقة فوق category.html - الخطوات دول
            // بقوا بيكملوا الجولة على الصفحة الجديدة، بنفس المحددات (selectors)
            // اللي createProductCardHTML بتبنيها دايماً، بس من غير بادئة
            // ".bose-product-detail-modal-body" اللي مبقاش لها وجود.
            { page: ['product.html'], mode: 'info', selector: '#bose-product-page-root .product-card-img', title: 'صورة المنتج', text: 'هتلاقي هنا صورة واضحة للمنتج، وتحت كده وصف تفصيلي للمكونات والطعم عشان تختاري صح.' },
            { page: ['product.html'], mode: 'info', selector: '#bose-product-page-root .product-card-price', title: 'السعر', text: 'وده السعر النهائي واضح قدامك من غير أي مفاجآت.' },
            { page: ['product.html'], mode: 'info', selector: '#bose-product-page-root .product-card-qty-wrapper', title: 'حددي الكمية', text: 'من هنا تقدري تزوّدي أو تقلّلي الكمية اللي حابة تطلبيها قبل ما تضيفيها لسلتك.' },
            { page: ['product.html'], mode: 'click', selector: '#bose-product-page-root .btn-add-to-cart', hint: 'دوسي على الزرار الوردي المكتوب عليه "أضيفي للسلة" تحت السعر', title: 'ضيفيه لسلتك', text: 'بعد ما تحددي اللي يناسبك، دوسي هنا عشان تضيفي المنتج ده لسلتك.' },
        ...
        checkout: [
            ...
            { page: ['checkout.html'], mode: 'info', selector: '#bose-payment-method-picker', title: 'طريقة الدفع', text: 'اختاري طريقة الدفع اللي تناسبك: الدفع عند الاستلام، أو الدفع أونلاين بتحويل كاش أو InstaPay على رقم المتجر (ولو اخترتي أونلاين اكتبي رقم المحفظة أو الهاتف اللي حوّلتي منه).' },
            { page: ['checkout.html'], mode: 'click', selector: '#btn-submit-order-final', hint: 'دوسي على الزرار المكتوب عليه "اطلبي دلوقتي" في آخر الصفحة', title: 'اطلبي دلوقتي', text: 'لما تراجعي كل حاجة وتكتبي رقم التحويل، دوسي هنا - طلبك هيتسجل فورًا وهنراجع التحويل ونتواصل معاكي لتأكيده.' },
            ...
            { page: ['order-success.html'], mode: 'info', selector: '#success-order-id-display', title: 'رقم طلبك', text: 'ده رقم طلبك، احتفظي بيه. طلبك اتسجل، وإحنا دلوقتي بنراجع التحويل وهنتواصل معاكي لتأكيده.' },
        ...
        rewards: [
            { page: ['rewards.html'], mode: 'info', selector: '.rw-hero', title: 'نادي مكافآت بوسي 👑', text: 'مرحبًا بيكِ في نادي مكافآت بوسي - هنوريكي بسرعة إزاي تكسبي خصومات تلقائية على طلباتك.' },
            { page: ['rewards.html'], mode: 'info', selector: '#rw-explainer-cards', title: 'خصومات تلقائية حسب ترتيب طلبك', text: 'كل ما تطلبي أكتر، كل ما تكسبي أكتر - الأرقام دي بتوضحلك نسبة الخصم اللي هتاخديها تلقائيًا حسب ترتيب طلبك.' },
            { page: ['rewards.html'], mode: 'info', selector: '.rw-form-card', title: 'اعرفي رصيدك دلوقتي', text: 'اكتبي رقم الهاتف اللي بتطلبي بيه عادةً هنا ودوسي "اعرضي رصيدي"، وهتشوفي فورًا طلبك الجاي هياخد خصم كام، وإمتى الخصم اللي بعده.' },
            { page: ['rewards.html'], mode: 'info', selector: '.rw-howto', title: 'إزاي يشتغل النظام بالتفصيل', text: 'وهنا شرح كامل لكل تفاصيل نظام المكافآت - من دورة الخصم لحد إزاي بيتطبق تلقائيًا وقت الدفع.' },
        ],
        track_order: [
            ...
            { page: ['track-order.html'], mode: 'info', selector: '#track-order-number', title: 'رقم الطلب', text: 'هتلاقيه في صفحة "تم استلام طلبك" اللي ظهرتلك بعد ما طلبتي.' },
