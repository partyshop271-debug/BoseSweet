...
(function() {
    ...
    function forceScrollToTop() {
        // 🛡️🆕 [إصلاح]: لو اللينك اللي فتحت بيه الصفحة فيه # (anchor)، سيبي
        // المتصفح يودّي العميلة لمكان الـ anchor نفسه، وما ترجعهاش لأول الصفحة
        // بالقوة. من غير الشرط ده، كانت العميلة بتوصل لجزء من الثانية لمكان
        // الـ anchor وبعدين بترجع تلقائي لأول الصفحة - وهي دايماً بتوصل بعد ما
        // الصفحة تخلص تحميل بالكامل (نداء window 'load') لأن forceScrollToTop
        // بتتنفذ 3 مرات: فورًا، وعلى DOMContentLoaded، وعلى load - وأي واحدة
        // فيهم من غير الشرط ده كانت كفيلة تلغي وصول العميلة لمكانها. باقي
        // روابط القائمة الجانبية (زي /cart.html، /menu.html...) مفيهاش #
        // أصلاً فمش بتتأثر، وده سبب إنها شغالة كويس من الأول.
                ...
                jsonLd["@graph"].push({
                    ...
                    "mainEntity": [
                        ...
                        },
                        {
                            ...
                            "acceptedAnswer": { "@type": "Answer", "text": "في صفحة إتمام الطلب تختاري بين الدفع عند الاستلام (كاش وقت الاستلام) أو الدفع أونلاين بالتحويل على InstaPay أو محفظة إلكترونية، وطلبك بيتسجل فوراً وبنتواصل معاكي لتأكيده." },
                        },
                        {
                            "@type": "Question",
