...
module.exports = async function handler(req, res) {
    try {
        ...
        // 🆕👑 [رجوع صفحة المنتج المستقلة]: كل منتج بقى بيتفهرس برابط صفحته
        // الحقيقية المستقلة تاني (product.html?slug=)، بدل رابط صفحة الفئة +
        // باراميتر product= (اللي كان بيفتح نافذة - اتشالت، راجع product.html).
