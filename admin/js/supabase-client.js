...
(function () {
     ...
     * البيانات get_bose_data_version(). طلب صغير جداً (قيمة واحدة بس) بيستخدمه
     * core-engine.js عشان يقرر يفضل مستخدم الكاش المحلي (localStorage) ولا
     * يجيب بيانات كاملة جديدة - بدل ما يستنى انتهاء صلاحية الكاش بالوقت بس.
     */
