 ...
 * 🛡️ التحديث الأمني الجديد: تم زراعة مستشعر BoseMonitor لمراقبة رندر الطلبات والعمليات المالية.
 */
...
window.renderAdminOrderFilters = function() {
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'renderAdminOrderFilters');
    }
};
...
window.setAdminOrderFilter = function(f) { 
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'setAdminOrderFilter');
    }
};
...
window.filterOrdersByDate = function() { 
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'filterOrdersByDate');
    }
};
...
window.refreshOrders = function() { 
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'refreshOrders');
    }
};
...
window.renderAdminOrders = function() {
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'renderAdminOrders');
    }
};
...
window.openOrderDetails = function(orderId) {
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'openOrderDetails');
    }
};
...
window.closeOrderModal = function() {
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'closeOrderModal');
    }
};
    ...
    try {
        ...
        if (orderIdx > -1) {
            ...
            try {
                ...
                if(window.BoseMonitor) window.BoseMonitor.report(e, 'admin-orders.js', null, null, 'updateOrderStatus (Firebase Sync)');
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'updateOrderStatus (Master)');
    }
};
...
window.triggerMakeWebhook = async function(orderData, status) {
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(e, 'admin-orders.js', null, null, 'triggerMakeWebhook');
...
window.printOrderInvoice = function() { 
    try {
        ...
        if(window.BoseMonitor) window.BoseMonitor.report(error, 'admin-orders.js', null, null, 'printOrderInvoice');
    }
};
